                ...
                <div class="box-body">
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
							...
							<th class="hidden-sm">轮询状态</th>
							<th class="hidden-md">轮询单号</th>
							<th class="hidden-sm">取消结果</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form class="deleteForm" method="POST" action="/admin/lunxun">
                ...
                <script>
                    $(function () {
                            ...
                            columnDefs: [
                                {
                                    ...
                                    var row_edit = {{Gate::forUser(auth('admin')->user())->check('admin.lunxun.edit') ? 1 : 0}};
                                    var row_delete = {{Gate::forUser(auth('admin')->user())->check('admin.lunxun.destroy') ? 1 :0}};
                                    var str = '';
                        ...
                        $("table").delegate('.delBtn', 'click', function () {
                            ...
                            $('.deleteForm').attr('action', '/admin/lunxun/' + id);
                            $("#modal-delete").modal();
                        });
